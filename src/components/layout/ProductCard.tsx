...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="flex flex-col  bg-gray-900  border border-gray-800/80 rounded-3xl p-4 transition-transform hover:-translate-y-1 hover:shadow-2xl">
      ...
      <div className="flex flex-col flex-1">
        ...
        <Link href={`/product/${product.id}`}>
          <h3 className="text-xl font-semibold text-white mb-2 line-clamp-2 hover:text-primary transition-colors">
            {product.title}
          </h3>
        </Link>
